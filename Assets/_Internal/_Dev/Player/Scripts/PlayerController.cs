...
public class PlayerController : MonoBehaviour
{
    ...
    private void Move()
    {
        ...
        //_anchor.Translate(_direction * _distanse * Time.deltaTime);
    }
    ...
    private void CalculateMoveParams()
    {
        ...
        _distanse = _maxSpeed * _deviationCurve.Evaluate(_controlDeviation / _maxControlDeviation);
        _direction = _heading.normalized;
    }

    private void SlowDownParams()
    {
        //_distanse = Mathf.Lerp(_distanse, 0f, (1 - _inertia) * Time.deltaTime);
    }
